...
image:../../../images/build.errors/1.appveyor.error.jpg[1.appveyor.error.jpg]

*Travis* 

The scripts copied from ShipDriver do not have execute permission. As a result permission to run is denied.

image:../../../images/build.errors/2.travis.error.jpg[2.travis.error.jpg]
...
image:../../../images/build.errors/3.circleci.error.jpg[3.circleci.error.jpg]
