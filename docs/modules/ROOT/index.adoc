...
link:Metadata-Flow[metadata files]
...
OpenCPN. His guide is [[here|https://github.com/leamas/OpenCPN/wiki]].

The [[OpenCPN Developers
Manual|https://opencpn.org/wiki/dokuwiki/doku.php?id=opencpn:developer_manual:pi_installer_summary]]
...
[[ShipDriver|https://github.com/Rasbats/shipdriver_pi]] (Master branch).
To show the process from the start
[[TideFinder|https://github.com/Rasbats/TideFinder_pi]] is used as an
illustration.
...
{empty}[[Alternative Workflow for Managed
Plugins|Alternative-Workflow|]]
